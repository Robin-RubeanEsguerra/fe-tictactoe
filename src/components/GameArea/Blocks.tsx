...
export const Blocks = ({ children, onClick, index }: BlockProps) => {
  ...
  return (
    <div
      key={index}
      onClick={onClick}
      className="scale-on-hover hover:border-4 hover:border-ttt-orange rounded-xl hover:cursor-pointer drop-shadow-amber-600 h-24 w-24 md:h-32 md:w-32 bg-white border-gray-300 border-3 text-white text-2xl font-bold flex justify-center items-center relative"
    >
