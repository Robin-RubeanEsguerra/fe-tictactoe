...
export const SpecialButton = ({
  ...
  return (
    <button
      type={type}
      onClick={onClick}
      className={`relative w-60 md:w-96 text-shadow-stroke hover:cursor-pointer scale-on-hover text-shadow-amber-800 
       text-[2rem] md:text-[4rem] flex items-center justify-center text-white ${className}`}
    >
      <Image
        src={backgroundImage}
